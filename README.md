...
- **ETL to Excel**: Automating data processing using Python, pandas, and openpyxl to deliver streamlined data reporting. 
...
- **IT Issue Tracking System**: A comprehensive tool for managing IT issues, complete with filtering, updating, and priority-based categorization. 
